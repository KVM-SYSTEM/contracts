...
var MaterialService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "core_server/core.proto",
}
...
const (
	...
	SectionService_GetSectionByDivideID_FullMethodName = "/core.SectionService/GetSectionByDivideID"
)
...
type SectionServiceClient interface {
	...
	GetSectionByDivideID(ctx context.Context, in *GetSectionByDivideIDReq, opts ...grpc.CallOption) (*GetSectionByDivideIDRes, error)
}
...
func (c *sectionServiceClient) GetSectionByDivideID(ctx context.Context, in *GetSectionByDivideIDReq, opts ...grpc.CallOption) (*GetSectionByDivideIDRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSectionByDivideIDRes)
	err := c.cc.Invoke(ctx, SectionService_GetSectionByDivideID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SectionServiceServer interface {
	...
	GetSectionByDivideID(context.Context, *GetSectionByDivideIDReq) (*GetSectionByDivideIDRes, error)
...
func (UnimplementedSectionServiceServer) GetSectionByDivideID(context.Context, *GetSectionByDivideIDReq) (*GetSectionByDivideIDRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSectionByDivideID not implemented")
}
...
func _SectionService_GetSectionByDivideID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSectionByDivideIDReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SectionServiceServer).GetSectionByDivideID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SectionService_GetSectionByDivideID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SectionServiceServer).GetSectionByDivideID(ctx, req.(*GetSectionByDivideIDReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SectionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSectionByDivideID",
			Handler:    _SectionService_GetSectionByDivideID_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "core_server/core.proto",
